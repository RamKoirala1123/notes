...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  },
  {
    id: "bold",
    title: "Bold",
    description: "Format text as bold with **text**",
    category: "Basic Blocks",
    icon: Bold,
    iconBg: "bg-neutral-800",
    iconColor: "text-neutral-200",
    keywords: ["bold", "strong", "b", "**", "format"],
    execute: () => ({ replacement: "****", cursorOffset: 2 }),
  },
  {
    id: "italic",
    title: "Italic",
    description: "Format text as italic with *text*",
    category: "Basic Blocks",
    icon: Italic,
    iconBg: "bg-neutral-800",
    iconColor: "text-neutral-200",
    keywords: ["italic", "em", "emphasis", "i", "*", "slant", "format"],
    execute: () => ({ replacement: "**", cursorOffset: 1 }),
  },
  {
    id: "html-link",
    title: "HTML Link",
    description: 'HTML anchor link <a href="..." target="_blank">',
    category: "Basic Blocks",
    icon: Globe,
    iconBg: "bg-sky-950/60",
    iconColor: "text-sky-400",
    keywords: ["html", "link", "anchor", "a", "href", "url", "web"],
    execute: () => ({
      replacement: '<a href="https://" target="_blank">link text</a>',
      cursorOffset: 17,
    }),
  },
  {
    id: "link",
    title: "Web Link",
    description: "Markdown link [text](https://...)",
    category: "Basic Blocks",
    icon: LinkIcon,
    iconBg: "bg-blue-950/60",
    iconColor: "text-blue-400",
    keywords: ["link", "url", "web", "markdown", "http", "https"],
    execute: () => ({ replacement: "[link text](https://)", cursorOffset: 19 }),
  },
  {
    id: "divider",
    title: "Divider",

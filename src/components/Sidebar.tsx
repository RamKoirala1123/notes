  ...
  return (
    ...
    >
      ...
      <div className="px-3 pb-2 flex items-center justify-between gap-1.5 shrink-0 border-b border-white/[0.06]">
        {/* Notes vs Todos Segmented Control */}
        <div className="flex items-center p-0.5 rounded-lg bg-white/[0.03] border border-white/[0.06] flex-1 text-xs">
          <button
            ...
            className={`flex-1 py-1 rounded-md flex items-center justify-center gap-1.5 text-xs transition-all ${
              activeView === "notes"
          ...
          >
            ...
            <span>Todos</span>
            {pendingTodosCount > 0 && (
              <span className="px-1.5 py-0.2 rounded-full bg-white/[0.1] text-neutral-300 text-[10px] font-medium">
                {pendingTodosCount}
              </span>
            )}
          </button>
      ...
      {/* Main Unified Scrollable Content (Folders + Notes + Tags) */}
      <div className="flex-1 overflow-y-auto px-3 py-3 space-y-6">
        ...
        {/* Tags Section (Clean, Collapsible, Integrated) */}
        {allTags.length > 0 && (
          <div className="pt-3 border-t border-white/[0.06]">
            <div className="flex items-center justify-between px-2 mb-2.5">
              <button
                ...
                className="flex items-center gap-1.5 text-[11px] font-semibold text-neutral-400 uppercase tracking-wider hover:text-neutral-200 transition-colors"
              >
                <ChevronRight
                  className={`w-3.5 h-3.5 transition-transform duration-150 ${
                    isTagsExpanded ? "rotate-90 text-neutral-400" : "text-neutral-500"
                  }`}
                />
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs transition-all ${
                        isSelected
                          ...
                          : "bg-white/[0.03] border border-white/[0.06] text-neutral-400 hover:text-neutral-200 hover:bg-white/[0.06] hover:border-white/[0.12]"
                      }`}
                    >
                      <span className="text-neutral-500">#</span>
                      <span>{tag}</span>
                      <span className="text-[10px] text-neutral-500 font-mono ml-0.5">
                        {tagCounts[tag]}
                      </span>
                    </button>
                  );
